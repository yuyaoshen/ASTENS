...
public interface ECMAScriptVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link ECMAScriptParser#identifierNonterminal}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIdentifierNonterminal(ECMAScriptParser.IdentifierNonterminalContext ctx);
}