...
public interface GolangVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitDotAccess(GolangParser.DotAccessContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code PrimaryExprTypeAssertion}
	 * labeled alternative in {@link GolangParser#primaryExpr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPrimaryExprTypeAssertion(GolangParser.PrimaryExprTypeAssertionContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitFunctionCall(GolangParser.FunctionCallContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitRelationalExpression(GolangParser.RelationalExpressionContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitDontKnowWhatToPutHere(GolangParser.DontKnowWhatToPutHereContext ctx);
	/**
	 * Visit a parse tree produced by the {@code LogicalAndOrExpression}
	 * labeled alternative in {@link GolangParser#expression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitLogicalAndOrExpression(GolangParser.LogicalAndOrExpressionContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitShiftExpression(GolangParser.ShiftExpressionContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitEqualityExpression(GolangParser.EqualityExpressionContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitBitwiseExpression(GolangParser.BitwiseExpressionContext ctx);
	/**
